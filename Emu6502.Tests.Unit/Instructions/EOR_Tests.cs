...
public abstract class EOR_Tests : InstructionTestBase
{
    public EOR_Tests(ITestOutputHelper output) : base(output) { }

    protected abstract void EOR_instruction_test_memory_setup(ICpu cpu, byte operand);

    [Theory]                     //nvdizc
    [InlineData(0x00, 0x00, 0x00, "000010")]
    [InlineData(0x00, 0x01, 0x01, "000000")]
    [InlineData(0x10, 0x00, 0x10, "000000")]
    [InlineData(0x10, 0x01, 0x11, "000000")]
    [InlineData(0x11, 0x22, 0x33, "000000")]
    [InlineData(0xFF, 0x00, 0xFF, "100000")]
    [InlineData(0x00, 0xFF, 0xFF, "100000")]
    ...
    {
        EOR_instruction_test_memory_setup(CpuMock, memory);
    ...
    public class Immediate : EOR_Tests
    {
        public Immediate(ITestOutputHelper output) : base(output) { }

        public override int NumberOfCyclesForExecution => 1;
        protected override Instruction Sut { get; } = new EOR_Immediate();

        protected override void EOR_instruction_test_memory_setup(ICpu cpu, byte operand)
        {
            Memory[0x0000] = operand;
        }
    }

    public class Absolute : EOR_Tests
    {
        public Absolute(ITestOutputHelper output) : base(output) { }

        public override int NumberOfCyclesForExecution => 3;
        protected override Instruction Sut { get; } = new EOR_Absolute();
    ...
    public class AbsoluteX : EOR_Tests
    {
        public AbsoluteX(ITestOutputHelper output) : base(output) { }

        public override int NumberOfCyclesForExecution => 3;
        protected override Instruction Sut { get; } = new EOR_AbsoluteX();
        ...
        protected override void EOR_instruction_test_memory_setup(ICpu cpu, byte value)
        {
            Memory[0x0000] = 0x03;
            Memory[0x0001] = 0x04;
            Memory[0x0002] = 0xff;
    ...
    public class AbsoluteY : EOR_Tests
    {
        public AbsoluteY(ITestOutputHelper output) : base(output) { }

        public override int NumberOfCyclesForExecution => 3;
        protected override Instruction Sut { get; } = new EOR_AbsoluteY();
    ...
    public class Zeropage : EOR_Tests
    {
        ...
        public override void SteppedThroughVerification()
        {
            CpuMock.Registers.A.Should().Be(0x10);
        }
    ...
    public class ZeropageX : EOR_Tests
    {
        public ZeropageX(ITestOutputHelper output) : base(output) { }

        public override int NumberOfCyclesForExecution => 3;
        protected override Instruction Sut { get; } = new EOR_ZeropageX();
    ...
    public class IndirectX : EOR_Tests
    {
        ...
        public override void SteppedThroughVerification()
        {
            CpuMock.Registers.A.Should().Be(0x14);
        }
